...
namespace Northwind.Entity
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual DbSet<hevfbwefew> hevfbwefews { get; set; }
        ...
        [DbFunction("NorthwindEntities", "FN_KATEGORI")]
        public virtual IQueryable<FN_KATEGORI_Result> FN_KATEGORI(Nullable<int> productidd)
        {
            var productiddParameter = productidd.HasValue ?
                new ObjectParameter("productidd", productidd) :
                new ObjectParameter("productidd", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_KATEGORI_Result>("[NorthwindEntities].[FN_KATEGORI](@productidd)", productiddParameter);
        }
    
        [DbFunction("NorthwindEntities", "FN_KDVLI")]
        public virtual IQueryable<FN_KDVLI_Result> FN_KDVLI(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_KDVLI_Result>("[NorthwindEntities].[FN_KDVLI](@ID)", iDParameter);
        }
    
        [DbFunction("NorthwindEntities", "FN_ORNEK")]
        public virtual IQueryable<FN_ORNEK_Result> FN_ORNEK(Nullable<int> personelID, Nullable<int> yil)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_ORNEK_Result>("[NorthwindEntities].[FN_ORNEK](@personelID, @yil)", personelIDParameter, yilParameter);
        }
    
        [DbFunction("NorthwindEntities", "FN_PRODUCTS_DETAILS")]
        public virtual IQueryable<FN_PRODUCTS_DETAILS_Result> FN_PRODUCTS_DETAILS(string customerID)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("customerID", customerID) :
                new ObjectParameter("customerID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_PRODUCTS_DETAILS_Result>("[NorthwindEntities].[FN_PRODUCTS_DETAILS](@customerID)", customerIDParameter);
        }
    
        [DbFunction("NorthwindEntities", "FN_PRODUCTSOFCUSTOMER")]
        public virtual IQueryable<FN_PRODUCTSOFCUSTOMER_Result> FN_PRODUCTSOFCUSTOMER(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_PRODUCTSOFCUSTOMER_Result>("[NorthwindEntities].[FN_PRODUCTSOFCUSTOMER](@ID)", iDParameter);
        }
        ...
        public virtual ObjectResult<string> GetCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GetCategories");
        }
    
        public virtual ObjectResult<KargoFirmasınaUrun_Result> KargoFirmasınaUrun(string name, Nullable<decimal> mingfreight, Nullable<decimal> maxfreight)
        {
            var nameParameter = name != null ?
                new ObjectParameter("name", name) :
                new ObjectParameter("name", typeof(string));
    
            var mingfreightParameter = mingfreight.HasValue ?
                new ObjectParameter("mingfreight", mingfreight) :
                new ObjectParameter("mingfreight", typeof(decimal));
    
            var maxfreightParameter = maxfreight.HasValue ?
                new ObjectParameter("maxfreight", maxfreight) :
                new ObjectParameter("maxfreight", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<KargoFirmasınaUrun_Result>("KargoFirmasınaUrun", nameParameter, mingfreightParameter, maxfreightParameter);
        }
    
        public virtual ObjectResult<Kontrol_Result> Kontrol()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Kontrol_Result>("Kontrol");
        }
        ...
        public virtual ObjectResult<sp_personel_ekle_Result> sp_personel_ekle(string firstname, string lastName, string country, Nullable<int> reportsTo)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_personel_ekle_Result>("sp_personel_ekle", firstnameParameter, lastNameParameter, countryParameter, reportsToParameter);
        }
    
        public virtual int sp_PersonelUPDATE(Nullable<int> employeeid, string firstname, string lastName, string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_PersonelUPDATE", employeeidParameter, firstnameParameter, lastNameParameter, countryParameter);
        }
        ...
        public virtual int TabloOlustur(string tabloadi, string kolonadi1, string kolon1tipi, string kolonadi2, string kolon2tipi)
        {
            var tabloadiParameter = tabloadi != null ?
                new ObjectParameter("tabloadi", tabloadi) :
                new ObjectParameter("tabloadi", typeof(string));
    
            var kolonadi1Parameter = kolonadi1 != null ?
                new ObjectParameter("kolonadi1", kolonadi1) :
                new ObjectParameter("kolonadi1", typeof(string));
            ...
            var kolonadi2Parameter = kolonadi2 != null ?
                new ObjectParameter("kolonadi2", kolonadi2) :
                new ObjectParameter("kolonadi2", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TabloOlustur", tabloadiParameter, kolonadi1Parameter, kolon1tipiParameter, kolonadi2Parameter, kolon2tipiParameter);
        }
        ...
        public virtual ObjectResult<UrunfiyatGuncelle_Result> UrunfiyatGuncelle(string islem, Nullable<double> zam, Nullable<int> productId)
        {
            var islemParameter = islem != null ?
                new ObjectParameter("islem", islem) :
                new ObjectParameter("islem", typeof(string));
    
            var zamParameter = zam.HasValue ?
                new ObjectParameter("zam", zam) :
                new ObjectParameter("zam", typeof(double));
    
            var productIdParameter = productId.HasValue ?
                new ObjectParameter("productId", productId) :
                new ObjectParameter("productId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UrunfiyatGuncelle_Result>("UrunfiyatGuncelle", islemParameter, zamParameter, productIdParameter);
        }
    
        public virtual ObjectResult<urunler_getir_Result> urunler_getir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<urunler_getir_Result>("urunler_getir");
        }
    
        public virtual int Yedekolustur(string kolonadi1, string kolon1tipi, string kolonadi2, string kolon2tipi)
        {
            var kolonadi1Parameter = kolonadi1 != null ?
                new ObjectParameter("kolonadi1", kolonadi1) :
                new ObjectParameter("kolonadi1", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Yedekolustur", kolonadi1Parameter, kolon1tipiParameter, kolonadi2Parameter, kolon2tipiParameter);
        }
    }
}
